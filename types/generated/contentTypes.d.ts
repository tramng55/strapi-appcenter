...
export interface ApiAppApp extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isShowWeb: Attribute.Boolean;
    bundle: Attribute.String;
    ...
    versions: Attribute.Relation<
      ...
      'api::version.version'
    >;
    enviroments: Attribute.Relation<
      'api::app.app',
      'oneToMany',
...
export interface ApiEnviromentEnviroment extends Schema.CollectionType {
...
export interface ApiOperationSystemOperationSystem
  extends Schema.CollectionType {
  collectionName: 'operation_systems';
  info: {
    singularName: 'operation-system';
    pluralName: 'operation-systems';
    displayName: 'Operation_System';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::operation-system.operation-system',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiVersionVersion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    releaseNotes: Attribute.String;
    pathFile: Attribute.String;
    branch: Attribute.String;
    isShowPopup: Attribute.Boolean;
    isLates: Attribute.Boolean;
    isShowHeader: Attribute.Boolean;
    isForce: Attribute.Boolean;
    operation_systems: Attribute.Relation<
      'api::version.version',
      'oneToMany',
      'api::operation-system.operation-system'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::operation-system.operation-system': ApiOperationSystemOperationSystem;
