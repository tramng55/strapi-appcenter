...
//     async find(ctx) {
//         try {
//             const {enviromentId, systemId} = ctx.header
//             const filters = {};
//             if(enviromentId) {
//                 filters['enviroments.id'] = { $contains: enviromentId};
//             }
//             if(systemId) {
//                 filters["systems.id"] = { $contains: systemId};
//             }
...
//       //   const apps = await strapi.services.app.find(ctx.query)
//       //   ctx.send(apps); 
//       // } catch (err){
